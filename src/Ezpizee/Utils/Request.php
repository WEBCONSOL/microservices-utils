...
final class Request
{
    ...
    public function hasHeaderParam($param): bool {
    ...
    public function httpsSchema(): string {return 'https://';}
    public function httpSchema(): string {return 'http://';}

    public function getRequestParamAsArray($param, $default = []): array
    {
