...
final class Response implements JsonSerializable
{
    ...
    public function getCode(): int {return (int)($this->data['code'].'');}
    ...
    public function isError(): bool {return $this->getCode() !== 200;}

    public function jsonSerialize() {return ['method'=>$this->method, 'endpoint'=>$this->endpoint, 'data'=>$this->data];}

    public function __toString() {return json_encode(['method'=>$this->method, 'endpoint'=>$this->endpoint, 'data'=>$this->data]);}
}