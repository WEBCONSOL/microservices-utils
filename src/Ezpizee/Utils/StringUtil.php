...
final class StringUtil
{
    ...
    public static function str2regex($str): string
    {
        return $str && is_string($str) ? "/" . preg_quote($str, "/") . "/" : "";
    }

    public static function alphaNumericOnly($string): string
    {
        return preg_replace("/[^A-Za-z0-9 ]/", '', $string);
    }

    public static function getJSONContent($file): stdClass
    {
    ...
    public static function isIP($str): bool
    {
        return filter_var($str, FILTER_VALIDATE_IP) ? true : false;
    }

    public static function isNotHttps($uri): bool
    {
        return !self::isHttps($uri);
    }

    public static function isHttps($uri): bool
    {
